...
//printing non basic variables in an iteration
...
//printing basic variables and minimum ratios in an iteration
...
//printing basic feasible solutions
...
int main()
{
	...
	while(1)
	{
		...
		cout<<"2. Initial Simplex table"<<endl;
		cout<<"3. List of non basic variables in the initial table"<<endl;
		cout<<"4. Basic variables with minimum ratios in the first iteration"<<endl;
		cout<<"5. Simplex table of the 2nd iteration"<<endl;
		cout<<"6. EXIT"<<endl;
		...
		{
			cout<<endl<<"List of non basic variables in the initial table :\t";
			non_basic(simplex_iterations, 0);
		}
		else if(ch==4)
		{
			cout<<endl<<"Basic variables with minimum ratios in the first iteration :"<<endl;
			basic(simplex_iterations[1]);
		}
		else if(ch==5)
		{
			if(simplex_iterations.size()<3)
			{
				cout<<"Problem is solved in less than 2 iterations."<<endl;
				continue;
			}
			cout<<endl<<"Simplex table of the 2nd iteration"<<endl;
			print(simplex_iterations[2]);
		}
		else break;
	}
	return 0;
